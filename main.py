"""
Code Reviewer — Senior engineer feedback on any code
...
DB_FILE      = "code_reviewer.db"
SYSTEM_PROMPT = "You are an expert Code Reviewer assistant. Paste code and get a thorough review covering bugs, security, performance, and style."
...
<div id="auth-overlay">
  <div class="auth-box">
    <div class="auth-logo">Code Reviewer</div>
    <div class="auth-sub">Senior engineer feedback on any code</div>
    <div class="auth-tabs">
...
<header id="main-header" style="display:none">
  <div class="hdr-left">
    <div class="logo">Code Reviewer</div>
...
<div class="wrap" id="main-app" style="display:none">
  <div class="hero">
    ...
    <h1><em>Code Reviewer</em><br>Senior engineer feedback on any code</h1>
    <p>Paste code and get a thorough review covering bugs, security, performance, and style. Built for users.</p>
  </div>
  ...
  <div class="card" id="input-card">
    <div class="card-hd">
      ...
      <button class="card-action" onclick="clearForm()">Clear</button>
        ...
        <div class="field">
      <label for="field-code_snippet">Code Snippet</label>
      <textarea id="field-code_snippet" placeholder="Enter code snippet..." required></textarea>
    </div>
    <div class="field">
      <label for="field-language">Language</label>
      <select id="field-language">
    ...
    <div class="field">
      <label for="field-focus_area">Focus Area</label>
      <select id="field-focus_area">
        <option value="">— Select —</option>
  ...
  <footer>
    <div class="foot-note">Code Reviewer &middot; Powered by Groq llama-3.3-70b</div>
...
const APP = {
  ...
  inputs:         [{"id": "code_snippet", "label": "Code Snippet", "type": "textarea", "placeholder": "Enter code snippet...", "required": true}, {"id": "language", "label": "Language", "type": "select", "options": ["Python", "JavaScript", "TypeScript", "Go", "Rust", "Java", "C#", "Other"], "required": false}, {"id": "focus_area", "label": "Focus Area", "type": "select", "options": ["Bugs", "Security", "Performance", "Code style", "All of the above"], "required": false}],
};
